...
This skill is for the common workflow where you drop in a link — a Xiaohongshu post, blog post, company article, essay, or documentation page — and want three things done in one pass:

1. extract the useful ideas conservatively
2. create a single Feishu cloud doc for that source
3. append the result to an existing roundup/index doc
...
- It prefers honest structured summaries over pretending to have a full transcript.
